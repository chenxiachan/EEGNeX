...
def EEGNet_4_2(n_timesteps, n_features, n_outputs):
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='EEGNet_4_2.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def EEGNet_8_2(n_timesteps, n_features, n_outputs):
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='EEGNet_8_2.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def test1(n_timesteps, n_features, n_outputs):
    ...
    model.add(Input(shape=(1, n_features, n_timesteps)))
    # 
    model.add(Conv2D(filters=4, kernel_size=(1, 32), use_bias = False, padding='same', data_format="channels_first"))
    model.add(BatchNormalization())
    model.add(Activation(activation='elu'))
    model.add(Conv2D(filters=4, kernel_size=(1, 32), use_bias = False, padding='same', data_format="channels_first"))
    model.add(BatchNormalization())
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='test1.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def test2(n_timesteps, n_features, n_outputs):
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='test2.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def test3(n_timesteps, n_features, n_outputs):
    ...
    model.add(Conv2D(filters=16, kernel_size=(1, 16), use_bias = False, dilation_rate=(1, 2), data_format='channels_first'))
    model.add(BatchNormalization())
    model.add(Activation(activation='elu'))
    
    model.add(Conv2D(filters=8, kernel_size=(1, 16), use_bias = False, dilation_rate=(1, 4),  data_format='channels_first'))
    model.add(BatchNormalization())
    model.add(Activation(activation='elu'))
    model.add(Dropout(0.5))
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='test3.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
...
def test4(n_timesteps, n_features, n_outputs):
    ...
    # save a plot of the model
    plot_model(model, show_shapes=True, to_file='test4.png')
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
